...
# START_DESCRIBE RHEL-07-010372
  describe file('/etc/pam.d/password-auth') do
    its('content') { should match /^auth\s+required\s+pam_faillock\.so\s+preauth\s+silent\s+audit\s+deny=3\s+even_deny_root\s+unlock_time=([0-9]|[1-8][0-9]|9[0-9]|[1-8][0-9]{2}|9[0-8][0-9]|99[0-9]|[1-8][0-9]{3}|9[0-8][0-9]{2}|99[0-8][0-9]|999[0-9]|[1-8][0-9]{4}|9[0-8][0-9]{3}|99[0-8][0-9]{2}|999[0-8][0-9]|9999[0-9]|[1-5][0-9]{5}|60[0-3][0-9]{3}|604[0-7][0-9]{2}|604800)$/ }
    its('content') { should match /^auth\s+\[default=die\]\s+pam_faillock\.so\s+authfail\s+audit\s+deny=3\s+even_deny_root\s+unlock_time=([0-9]|[1-8][0-9]|9[0-9]|[1-8][0-9]{2}|9[0-8][0-9]|99[0-9]|[1-8][0-9]{3}|9[0-8][0-9]{2}|99[0-8][0-9]|999[0-9]|[1-8][0-9]{4}|9[0-8][0-9]{3}|99[0-8][0-9]{2}|999[0-8][0-9]|9999[0-9]|[1-5][0-9]{5}|60[0-3][0-9]{3}|604[0-7][0-9]{2}|604800)$/ }
  end
