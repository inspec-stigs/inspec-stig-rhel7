...
# impacts
title 'RHEL-07-030670 - All uses of the init_module command must be audited.'
control 'RHEL-07-030670' do
  impact 0.5
  ...
  tag 'stig', 'RHEL-07-030670'
  tag severity: 'medium'
  tag checkid: 'C-RHEL-07-030670_chk'
  tag fixid: 'F-RHEL-07-030670_fix'
  tag version: 'RHEL-07-030670'
  tag ruleid: 'RHEL-07-030670_rule'
  tag fixtext: 'Configure the operating system generates audit records when successful/unsuccessful attempts to use the init_module command occur. 
...
The audit daemon must be restarted for the changes to take effect.'
  tag checktext: 'Verify the operating system generates audit records when successful/unsuccessful attempts to use the init_module command occur. 
