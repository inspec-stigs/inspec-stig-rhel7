...
# START_DESCRIBE RHEL-07-030402
  describe command('auditctl -l') do
    ...
    its('stdout') { should match /^-a always,exit -F arch=b64 -S lsetxattr -F auid>=1000 -F auid!=4294967295 -F subj=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0\.c1023 key=perm_mod/ }
  end
